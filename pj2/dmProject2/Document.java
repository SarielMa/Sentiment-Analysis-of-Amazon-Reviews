...
public class Document implements Comparable<Document>{
		 ...
		 */
		public Document(String filename, HashSet<String> sw) {
			this.filename = filename;
			termFrequency = new HashMap<String, Integer>();
			
			readFileAndPreProcess(sw);
		}
		 ...
		 */
		private void readFileAndPreProcess(HashSet<String> sw) {
			try {
